...
define('TEXT_WARNING_SSL_EDIT', 'Waarschuwing: <a href="http://www.zen-cart.com/content.php?56" target="_blank">Om veiligheidsredenen is het bewerken van deze module uitgeschakeld totdat uw Admin is geconfigureerd voor SSL</a>.');
define('TEXT_WARNING_SSL_INSTALL', 'Waarschuwing: <a href="http://www.zen-cart.com/content.php?56" target="_blank">Om veiligheidsredenen is de installatie van deze module uitgeschakeld totdat uw Admin is geconfigureerd voor SSL</a>.');

// Generic validation messages for modules
define('TEXT_POSITIVE_INT','%s moet een geheel getal groter dan of gelijk aan 0 zijn');
define('TEXT_POSITIVE_FLOAT','%s moet een decimaal groter dan of gelijk aan 0 zijn');
