...
define('TABLE_HEADING_ATTRIBUTES_PRICE_ONETIME', 'Eenmalig:');

define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_ONETIME', 'Eenmalige factor: ');
...
define('TABLE_TEXT_MAX_COUNT_SHORT', 'Max:');
  ...
  define('TABLE_HEADING_OPT_WEIGHT_PREFIX','Voorvoegsel');
...
// preview
  ...
  define('TEXT_DISPLAY_NUMBER_OF_ATTRIBUTES', 'Toon <b>%d</b> tot <b>%d</b> (van <b>%d</b> opties)');
