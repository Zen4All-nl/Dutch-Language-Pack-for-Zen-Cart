...
define('TEXT_NO_RECORDS_FOUND', 'Er zijn geen records gevonden met het geselecteerde filter.');

define('TEXT_EXPORTFORMAT0', 'Exporteer als HTML (ideaal voor om op het scherm te bekijken)');
define('TEXT_EXPORTFORMAT1', 'Exporteer naar CSV (ideal voor het importeren in spreadsheets)');
